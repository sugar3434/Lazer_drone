...
def main():
    ...
    # Список меток с параметрами для полета (скорость, высота, yaw)
    patrol_markers = [
        {"id": 515, "z": 1.0, "speed": 0.2, "yaw": 90},   # на нас (прямо)
        {"id": 525, "z": 1.0, "speed": 0.2, "yaw": 45},   # наискосок право
        {"id": 381, "z": 1.0, "speed": 0.2, "yaw": 0},    # право
        {"id": 165, "z": 1.0, "speed": 0.2, "yaw": 0},    # право
        {"id": 59,  "z": 1.0, "speed": 0.2, "yaw": 270},  # перед (прямо)
        {"id": 50,  "z": 1.0, "speed": 0.2, "yaw": 225},  # наискосок лево
        {"id": 170, "z": 1.0, "speed": 0.2, "yaw": 180},  # лево
        {"id": 386, "z": 0.8, "speed": 0.2, "yaw": 180}   # лево
    ]
        ...
        while True:
            ...
            if not is_healing:
                if time.time() - last_move_time > 8.0:
                    ...
                    # Используем параметры из списка (z, speed, yaw)
